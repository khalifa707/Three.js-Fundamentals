...
import { dashSize, gapSize, varyingProperty } from 'three/src/nodes/core/PropertyNode.js';
import { attribute } from 'three/src/nodes/core/AttributeNode.js';
import { cameraProjectionMatrix } from 'three/src/nodes/accessors/Camera.js';
import { materialColor, materialLineScale, materialLineDashSize, materialLineGapSize, materialLineDashOffset, materialLineWidth, materialOpacity } from 'three/src/nodes/accessors/MaterialNode.js';
import { modelViewMatrix } from 'three/src/nodes/accessors/ModelNode.js';
import { positionGeometry } from 'three/src/nodes/accessors/Position.js';
import { mix, smoothstep } from 'three/src/nodes/math/MathNode.js';
import { Fn, float, vec2, vec3, vec4, If } from 'three/src/nodes/tsl/TSLBase.js';
import { uv } from 'three/src/nodes/accessors/UV.js';
import { viewport } from 'three/src/nodes/display/ScreenNode.js';
