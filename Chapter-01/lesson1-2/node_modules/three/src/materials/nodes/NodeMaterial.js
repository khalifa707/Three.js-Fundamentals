...
import { getNodeChildren, getCacheKey } from 'three/src/nodes/core/NodeUtils.js';
import { attribute } from 'three/src/nodes/core/AttributeNode.js';
import { output, diffuseColor, emissive, varyingProperty } from 'three/src/nodes/core/PropertyNode.js';
import { materialAlphaTest, materialColor, materialOpacity, materialEmissive, materialNormal, materialLightMap, materialAO } from 'three/src/nodes/accessors/MaterialNode.js';
import { modelViewProjection } from 'three/src/nodes/accessors/ModelViewProjectionNode.js';
import { normalLocal } from 'three/src/nodes/accessors/Normal.js';
...
import { positionLocal, positionView } from 'three/src/nodes/accessors/Position.js';
import { skinning } from 'three/src/nodes/accessors/SkinningNode.js';
import { morphReference } from 'three/src/nodes/accessors/MorphNode.js';
import { mix } from 'three/src/nodes/math/MathNode.js';
import { float, vec3, vec4 } from 'three/src/nodes/tsl/TSLBase.js';
...
import { depth, viewZToLogarithmicDepth, viewZToOrthographicDepth } from 'three/src/nodes/display/ViewportDepthNode.js';
import { cameraFar, cameraNear, cameraProjectionMatrix } from 'three/src/nodes/accessors/Camera.js';
import { clipping, clippingAlpha, hardwareClipping } from 'three/src/nodes/accessors/ClippingNode.js';
import NodeMaterialObserver from 'three/src/materials/nodes/manager/NodeMaterialObserver.js';
import getAlphaHashThreshold from 'three/src/nodes/functions/material/getAlphaHashThreshold.js';
import { modelViewMatrix } from 'three/src/nodes/accessors/ModelNode.js';
